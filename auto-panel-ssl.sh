...
SQL_INSERT_TEMPLATE="
INSERT INTO settings VALUES (%d, 'webCertFile', '/etc/ssl/certs/3x-ui-public.crt');
...
gen_ssl_cert() {
    ...
    openssl req -new -x509 -newkey rsa:2048 -nodes -sha256 -keyout /etc/ssl/private/3x-ui-private.key -out /etc/ssl/certs/3x-ui-public.crt -days 1024
}
